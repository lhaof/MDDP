...
def parse_args_and_config():
    ...
    parser.add_argument('-r', '--root_dir', type=str, default='/mntnfs/med_lihaofeng/virtual_stain/logs/BBDM/CRC/BrownianBridge/sample_to_eval/', help='Path to the config file')
    parser.add_argument('-s', '--source_dir', type=str, default='200/', help='Path to the source directory')
    parser.add_argument('-t', '--target_dir', type=str, default='results/', help='Path to the target directory')
    parser.add_argument('-n', '--num_samples', type=int, default=1000, help='Path to the destination directory')
