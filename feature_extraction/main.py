...
def parse_args_and_config():
    ...
    parser.add_argument('-r', '--result_path', type=str, default='/data3/louwei/CRC-staining-dataset/CRC-CK-HE-IMAGES/tumor_subtypint_BBDM_features_level2/', help="The directory to save results")
