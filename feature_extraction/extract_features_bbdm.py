...
from utils_clam.utils import print_network, collate_features
from utils_clam.file_utils import save_hdf5
from utils_clam import dict2namespace, get_runner, namespace2dict
...
def parse_args_and_config():
    ...
    parser.add_argument('-r', '--result_path', type=str, default='/mntnfs/med_lihaofeng/virtual_stain/logs/BBDM/', help="The directory to save results")
